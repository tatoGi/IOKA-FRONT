...
const LiveInvestSection = ({
  ...
  const sliderData = additionalFields.slider_images.map((item, index) => ({
    id: index + 1,
    image: item.image,
    mobile_image: item.mobile_image, // add mobile_image
    url: item.url,
  ...
  // Find contact page
  const contactPage = navigationData.find(
    (page) => page.type_id === 3 && page.active === 1
  );
  ...
  return (
    <section className={styles.liveInvestSection}>
        ...
        <div className="row">
          <div className={`${styles.content} col-md-12`}>
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: sectionDataTwo.description }}
            ></div>
          </div>
          <div className={`${styles.sliderContainer} col-md-12`}>
            {isMobile ? (
                    ...
                    (
                      <SwiperSlide key={item.id}>
                        ...
                        >
                          <Image
                            src={
                              item.mobile_image && isMobile
                                ? `${process.env.NEXT_PUBLIC_API_URL}/storage/${decodeImageUrl(item.mobile_image)}`
                                : item.image
            ...
            <div className="container d-flex justify-content-between">
              ...
              >
                ...
                >
                  <path
                    d="M12.059 12.0598C12.6449 11.4738 12.6449 10.5223 12.059 9.93633L3.05898 0.936328C2.47305 0.350391 1.52148 0.350391 0.935547 0.936328C0.349609 1.52227 0.349609 2.47383 0.935547 3.05977L8.87617 11.0004L0.940234 18.941C0.354296 19.527 0.354296 20.4785 0.940234 21.0645C1.52617 21.6504 2.47773 21.6504 3.06367 21.0645L12.0637 12.0645L12.059 12.0598Z"
                    fill="#8FE3DC"
                  />
                </svg>
              </button>
      ...
      <div className={`container ${styles.statItems}`}>
        <div className={styles.statItemsLeft}>
          {additionalFields.rolling_numbers.map((item, index) => (
            <div
              key={index}
              className={styles.statItem}
              style={{
                marginRight: index === 0 && !isMobile ? "106px" : "0"
              }}
            >
        ...
        <div className={styles.statItemsRight}>
